...
async function updateBook(bookId) {
    ...
    const commentElement = document.querySelector('#message');
    const authorElement = document.querySelector('#author');
    const urlElement = document.querySelector('#url');

    const title = titleElement.value;
    const message = commentElement.value;
    ...
    const cancleButtonElement = document.querySelector('#btn-cancel');
    cancleButtonElement.addEventListener('click', event => {
...
function render(book) {
    ...
    const commentElement = document.querySelector('#message');
    commentElement.value = book.message;
